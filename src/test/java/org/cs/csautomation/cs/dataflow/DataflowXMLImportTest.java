 ...
 *
 */
public class DataflowXMLImportTest extends AbstractTest {
    ...
    private String                    scriptConfigTestSheet     = "XmlScriptConfigurationData";
    private String                    dataSourceConfigSheetName = "XmlDataSourceConfiguration";
    ...
    private String                    importXmlDataFilePath;
    private int                       expectedJobCount;
    private int                       actualJobCount;

    @Test(priority = 1, dataProvider = "importScriptConfigTestData", groups = {
            "Data flow XML import test" })
    public void testConfigureXMLfile(String targetFolderName,
        ...
        try {
            ...
            CSLogger.debug("Error in test method : testConfigureXMLfile", e);
            Assert.fail("Error in test method : testConfigureXMLfile", e);
        }
    }
     ...
     */
    @Test(priority = 2, dependsOnMethods = "testConfigureXMLfile", groups = {
            "Data flow XML import test" })
    public void testUploadXMLfile() {
        try {
            ...
            fileData = readDataFromXML(scriptData.get("importDataFilePath"));
            softAssertion.assertAll();
        } catch (Exception e) {
            CSLogger.debug(
                    "Automation error in test method : testUploadXMLfile" + e);
            Assert.fail(
                    "Automation error in test method : testUploadXMLfile" + e);
        }
    }
     ...
     */
    @Test(priority = 3, groups = { "Data flow XML import test" })
    public void testCreateImportXMLScript() {
        try {
            waitForReload = new WebDriverWait(browserDriver, 180);
            softAssertion = new SoftAssert();
            ...
            CSLogger.debug(
                    "Automation error in test method : testCreateImportXMLScript"
                            + e);
            Assert.fail(
                    "Automation error in test method : testCreateImportXMLScript"
                            + e);
    ...
    public void getImportScriptData(String targetFolderName,
        ...
        try {
            ...
            scriptData.put("importDataFilePath", importXmlDataFilePath);
        } catch (Exception e) {
    ...
    @Test(priority = 4, dataProvider = "configureDataSource", groups = {
            "Data flow XML import test" })
    public void testConfigureXMLDataSourceSection(String dataSourceType,
        ...
        try {
            ...
            CSLogger.debug(
                    "Automation error in test method : testConfigureXMLDataSourceSection"
                            + e);
            Assert.fail(
                    "Automation error in test method : testConfigureXMLDataSourceSection"
                            + e);
    ...
    @Test(priority = 5, dataProvider = "configureDataTarget", groups = {
            "Data flow XML import test" })
    public void testConfiureXMLDataTargetSection(String dataTargetType,
        ...
        try {
            ...
            CSLogger.debug(
                    "Automation error in test method : testConfiureXMLDataTargetSection"
                            + e);
            Assert.fail(
                    "Automation error in test method : testConfiureXMLDataTargetSection"
                            + e);
     ...
     */
    @Test(priority = 6, groups = { "Data flow XML import test" })
    public void testExecuteXMLImportScript() {
        try {
            waitForReload = new WebDriverWait(browserDriver, 60);
            softAssertion = new SoftAssert();
            ...
            CSLogger.debug(
                    "Automation error in test method : testExecuteXMLImportScript"
                            + e);
            Assert.fail(
                    "Automation error in test method : testExecuteXMLImportScript"
                            + e);
     ...
     */
    @Test(priority = 7, groups = { "Data flow XML import test" })
    public void testVerifyXMLImportedProduct() {
        try {
            waitForReload = new WebDriverWait(browserDriver, 60);
            softAssertion = new SoftAssert();
            switchToPimAndExpandProductsTree(waitForReload);
            ...
            CSLogger.debug(
                    "Automation error in test method : testVerifyXMLImportedProduct"
                            + e);
            Assert.fail(
                    "Automation error in test method : testVerifyXMLImportedProduct"
                            + e);
    ...
    @Test(priority = 8, dataProvider = "configureDataTransformation", groups = {
            "Data flow XML import test" })
    public void testConfigureXMLDataTransformationSection(String scriptTab,
        ...
        try {
            ...
            CSLogger.debug(
                    "Automation error in test method :     testConfigureXMLDataTransformationSection"
                            + e);
            Assert.fail(
                    "Automation error in test method :     testConfigureXMLDataTransformationSection"
                            + e);
    ...
    @Test(priority = 9, dataProvider = "configureDataTransformation", groups = {
            "Data flow XML import test" })
    private void testVerifyXMLTransformedProduct(String scriptTab,
            String dataTransformationField, String transformedName,
            String transformationType, String transformationStatus,
            String importInto, String transformationLanguage, String prefixText,
            String postfixText, String executionType, String importLayer,
        ...
        try {
            ...
            CSLogger.debug(
                    "Automation error in test method : testVerifyXMLTransformedProduct"
                            + e);
            Assert.fail(
                    "Automation error in test method : testVerifyXMLTransformedProduct"
                            + e);
    ...
    private void switchToMamAndExpandImportFolder(String volumeFolderName,
        ...
        uploadXMLFile(importFolderName, filePath);
    }
    ...
    private void verifyImportedProduct(String filePath,
        ...
        HashMap<String, String> fileData = readDataFromXML(filePath);
        goToPimStudioTreeSection();
        ...
        String actualExternalKey = browserDriver
                ...
                .getText();
        if (actualExternalKey.equals(fileData.get(fileheader.get(0)))) {
            CSLogger.info(
     ...
     *            String object contains name of product tab.
     */
    private void clkOnGivenTab(String productTabName) {
        waitForReload.until(ExpectedConditions
    ...
    private HashMap<String, String> readDataFromXML(String filePath) {
        try {
            ...
            Node generalNode = document.getElementsByTagName("Article").item(0);
    ...
    private void configureTransformation(String dataSourceFieldName,
        ...
        WebElement drpDwnTransformationStatus = browserDriver.findElement(By
                .xpath("//select[contains(@id,'DataflowimporttransformationStatus')]/option[contains(text(),'"
    ...
    private void verifyTransformedProduct(String filePath,
            ...
            String postfixText) {
        String transformedLabel = prefixText + fileData.get(fileheader.get(1))
                + postfixText;
        goToPimStudioTreeSection();
        WebElement importedProduct = browserDriver.findElement(By.xpath(
                "//span[contains(text(),'" + parentProductName + "')]/../../.."
     ...
     * volumeFolderName,importFolderName,fileName,dataSourceSectionFields
     * 
     * @return Array String array consisting of import data
     */
    ...
    public void initializeResource() {
        ...
        modalDialogPopupWindowInstance = new ModalDialogPopupWindow(
                browserDriver);
        importXmlDataFilePath = config.getDataflowTestDataFolder()
                + "DataflowXmlImportData.xml";
    }
}
