 ...
 *
 */
public class MergeProductContentCompareTest extends AbstractTest {
    ...
    private String                    mergeContentWindowHandle;
    ...
    private String                    dataDrivenSheetName = "MergeProductCompareVersion";
     ...
     *            product
     * @param changedFirstChildAttrValue Contains text attribute value for
     *            latest version
    ...
    public void testMergeProductContentCompareVersions(String parentProductName,
            String className, String productTextTypeAttrName,
            String firstChildProductName, String firstChildAttrValue,
            String changedFirstChildAttrValue, String secondChildProductName,
            String secondChildAttrValue, String productTabName) {
        try {
            ...
            mergeContentWindowHandle = switchToMergeContentWindow();
            ...
            CSLogger.debug(
                    "Automation error in : testMergeProductContentCompareVersions",
                    e);
            Assert.fail(
                    "Automation error in : testMergeProductContentCompareVersions",
                    e);
    ...
    public void testMergeProductContentCompareObject(String parentProductName,
            String className, String productTextTypeAttrName,
            String firstChildProductName, String firstChildAttrValue,
            String changedFirstChildAttrValue, String secondChildProductName,
            String secondChildAttrValue, String productTabName) {
        try {
            ...
            CSLogger.debug(
                    "Automation error in : testMergeProductContentCompareObject",
                    e);
            Assert.fail(
                    "Automation error in : testMergeProductContentCompareObject",
                    e);
     ...
     */
    private String switchToMergeContentWindow() {
        try {
            goToProductsRightSectionWindow();
     ...
     * 
     * @param productTextTypeAttrName Child product text attribute name
     * @param productTextTypeAttrValue Child product text attribute value
     * @param productFolderName String object containing product folder name
     * @param childProductName String object containing child product name
     * @param productTabName String object containing product tab name
     */
     ...
     */
    private void switchToMergeContentWindowTab() {
        browserDriver.switchTo().window(mergeContentWindowHandle);
        CSLogger.info("Switched to merge content window tab");
    }
     ...
     * data
     * 
     * @param productTextTypeAttrName String object containing text type
     *            attribute name
     * @param changedProductData String object containing changed value for
     *            verifying latest version attribute value
     */
    ...
    /**
     * Verifies whether merge content window exists and open
     */
    private void checkMergeContentWindowExists() {
        String currentWindow = browserDriver.getWindowHandle();
        if (mergeContentWindowHandle.equals(currentWindow)) {
            CSLogger.info("Merge content window exists");
        } else {
            CSLogger.error("Merge content window is not open");
            Assert.fail("Merge content window is not open");
        }
    }
     ...
     * 
     * @param nonMasterProduct String object containing name of Non-master
     *            object(child product)
     */
     ...
     * strike-through.
     */
    private void verifyComparison() {
        String nonMasterObjectLabelDifferences = browserDriver.findElement(
                By.xpath("//tr[@id='CSGItemComparatorAttribute_Label']/td"
                        + "[3]/div/div[5]/span"))
                .getAttribute("style");
        String masterObjectLabelDifferences = browserDriver
                .findElement(By
                        .xpath("//tr[@id='CSGItemComparatorAttribute_Label']/td"
                                + "[3]/div/div[5]/span[2]"))
                .getAttribute("style");
    ...
    /**
     * Closes Merge content window tab
     */
    ...
    public Object[][] getmergeProductContentCompVersionData() {
