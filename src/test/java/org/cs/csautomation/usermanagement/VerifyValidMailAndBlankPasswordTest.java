...
public class VerifyValidMailAndBlankPasswordTest extends AbstractTest {
    ...
    private String           verifyInvalidEmailSheet = "VerifyValidMailAndBlankPassword";
     ...
     */
    @Test(priority = 1, dataProvider = "verifyInvalidEmailAndBlankPassword")
    public void testVerifyInvalidEmailAddress(String emailAddress) {
        try {
            loginPage.clkSignUp(waitForReload);
            registerWithValidEmail(emailAddress);
            verifyAlertMessage();
    ...
    private void verifyAlertMessage() {
        try {
            ...
            if (alertText.equals("Please Enter Your Password")) {
                alert.accept();
    ...
    private void registerWithValidEmail(String emailAddress) {
     ...
     * @return
     */
    @DataProvider(name = "verifyInvalidEmailAndBlankPassword")
