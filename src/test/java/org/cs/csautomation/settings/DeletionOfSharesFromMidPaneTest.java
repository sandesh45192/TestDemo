...
/**
 * This class contains the test method to delete shares from mid pane
 * 
 * @author CSAutomation Team
 *
 */
public class DeletionOfSharesFromMidPaneTest extends AbstractTest {

    private WebDriverWait          waitForReload;
    private FrameLocators          locator;
    private CSPortalHeader         csPortalHeader;
    private CSGuiToolbarHorizontal guiToolbarHorizontal;
    private String                 sharesConfigSheet = "DeletionOfSharesFromMidPane";
     ...
     */
    @Test(dataProvider = "deletionOfSharesFromMidPane")
    public void testDeletionOfSharesFromMidPane(String labelCreateShare,
        ...
        try {
            ...
            CSLogger.info("‘Deletion of shares from mid pane’ test completed!");
        } catch (Exception e) {
            CSLogger.debug("Automation Error : testDeletionOfSharesFromMidPane",
                    e);
            Assert.fail("Automation error : testDeletionOfSharesFromMidPane",
                    e);
        }
    }
     ...
     * 
     * @param shareLabel - String instance - Label of share to be deleted
     */
    private void deleteShare(String labelDeleteShare) {
        ...
        if (status == true) {
            ...
            CSLogger.info(
                    "Clicked on context Object from context menu of share");
     ...
     * 
     * @param shareLabel - String instance - Label of share to be verified for
     *            deletion
     */
     ...
     */
    @DataProvider(name = "deletionOfSharesFromMidPane")
