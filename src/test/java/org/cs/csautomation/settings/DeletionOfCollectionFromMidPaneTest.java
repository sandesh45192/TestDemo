...
/**
 * This class contains the test method to delete collection from mid pane
 * 
 * @author CSAutomation Team
 *
 */
public class DeletionOfCollectionFromMidPaneTest extends AbstractTest {

    private WebDriverWait          waitForReload;
    private FrameLocators          locator;
    private CSPortalHeader         csPortalHeader;
    private CSGuiToolbarHorizontal guiToolbarHorizontal;
    private String                 collectionConfigSheet = "DeleteCollectionsFromMidPane";
     ...
     *            be deleted
     */
    @Test(dataProvider = "deletionOfCollectionFromMidPane")
    public void testDeletionOfCollectionsFromMidPane(
        ...
        try {
            ...
            CSLogger.info(
                    "‘Deletion of collections from mid pane’ test completed!");
        } catch (Exception e) {
            CSLogger.debug(
                    "Automation Error : testDeletionOfCollectionsFromMidPane",
                    e);
            Assert.fail(
                    "Automation error : testDeletionOfCollectionsFromMidPane",
                    e);
     ...
     */
    @DataProvider(name = "deletionOfCollectionFromMidPane")
